/* src/config/bitcoinblue-config.h.  Generated from bitcoinblue-config.h.in by configure.  */
/* src/config/bitcoinblue-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BITCOINBLUE_CONFIG_H

#define BITCOINBLUE_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BitcoinBlue Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BitcoinBlue Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bitcoinblue/bitcoinblue/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitcoinBlue Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitcoinBlue Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoinblue"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitcoinbluecore.org/"
